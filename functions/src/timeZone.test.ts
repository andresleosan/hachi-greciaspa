...
describe('timezone helpers', () => {
  it('converts Mexico City local date-time to an instant', () => {
    expect(fromZonedTime('2026-01-15T10:30', 'America/Mexico_City').toISOString()).toBe(
  ...
  it('preserves milliseconds when converting a zoned date-time', () => {
    expect(fromZonedTime('2026-01-15T10:30:00.123', 'America/Mexico_City').toISOString()).toBe(
      '2026-01-15T16:30:00.123Z',
    )
  })
})
