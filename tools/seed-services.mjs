...
const PRECIOS = [
  ...
  { id: 'spa-day-mini-largo', name: 'Spa Day Mini · Pelo largo sin nudos', price: 280, unit: '≤5 kg', note: 'Pelo largo sin nudos', category: 'Spa' },
  { id: 'spa-day-chica-largo', name: 'Spa Day Chica · Pelo largo sin nudos', price: 300, unit: '≤10 kg', note: 'Pelo largo sin nudos', category: 'Spa' },
  { id: 'spa-day-mediana-largo', name: 'Spa Day Mediana · Pelo largo sin nudos', price: 390, unit: '≤15 kg', note: 'Pelo largo sin nudos', category: 'Spa' },
  { id: 'spa-day-mediana-grande-largo', name: 'Spa Day Mediana/Grande · Pelo largo sin nudos', price: 490, unit: '≤20 kg', note: 'Pelo largo sin nudos', category: 'Spa' },
  { id: 'spa-day-grande-largo', name: 'Spa Day Grande · Pelo largo sin nudos', price: 690, unit: '≤30 kg', note: 'Pelo largo sin nudos', category: 'Spa' },
  // Guardería / Pensión
  { id: 'guarderia-eventual', name: 'Guardería · Eventual', price: 250, unit: '/día', note: 'Lun – Vie · 08:00 am – 06:00 pm', category: 'Estancia' },
  { id: 'guarderia-mensual', name: 'Guardería · Plan mensual', price: 3500, unit: '/mes', note: 'Lun – Vie · 08:00 am – 06:00 pm', category: 'Estancia' },
  { id: 'pension-temporada-baja', name: 'Pensión · Temporada baja', price: 300, unit: '/noche', note: 'Temporada baja', category: 'Estancia' },
  { id: 'pension-temporada-alta', name: 'Pensión · Temporada alta', price: 380, unit: '/noche', note: 'Temporada alta', category: 'Estancia' },
  // Extras
  { id: 'extra-aromaterapia', name: 'Aromaterapia (shampoo de aceites esenciales)', price: 140, unit: 'extra', note: null, category: 'Extra' },
  { id: 'extra-mascarilla-restauracion', name: 'Mascarilla restauración crecimiento saludable y nutrición capilar', price: 180, unit: 'extra', note: null, category: 'Extra' },
  { id: 'extra-mascarilla-hidratacion', name: 'Mascarilla hidratación, pelaje brillante y fácil de peinar', price: 180, unit: 'extra', note: null, category: 'Extra' },
  ...
  { id: 'extra-grooming-completo', name: 'Grooming (Spa + corte)', price: null, priceHigh: null, unit: 'variable', note: 'Precio según tamaño y tipo de pelo', category: 'Extra' },
